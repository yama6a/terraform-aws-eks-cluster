...
variable "event_subscription_post_endpoint" {
  type        = string
  default     = ""
  description = "Endpoint to receive events from EventBridge"
}
...
variable "event_subscribers" {
  description = "Map of event name to subscriber target ARN"
}
